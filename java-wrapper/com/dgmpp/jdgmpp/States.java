...
public class States {
  ...
  public void add(Module.State x) {
    dgmppJNI.States_add(swigCPtr, this, x.swigValue());
  }

  public Module.State get(int i) {
    return Module.State.swigToEnum(dgmppJNI.States_get(swigCPtr, this, i));
  }

  public void set(int i, Module.State val) {
    dgmppJNI.States_set(swigCPtr, this, i, val.swigValue());
  }
