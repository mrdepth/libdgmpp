...
public class GroupIDs {
  ...
  public void add(GroupID x) {
    dgmppJNI.GroupIDs_add(swigCPtr, this, x.swigValue());
  }

  public GroupID get(int i) {
    return GroupID.swigToEnum(dgmppJNI.GroupIDs_get(swigCPtr, this, i));
  }

  public void set(int i, GroupID val) {
    dgmppJNI.GroupIDs_set(swigCPtr, this, i, val.swigValue());
  }
