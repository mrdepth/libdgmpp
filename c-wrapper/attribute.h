...
DGMPP_EXTERN dgmpp_type			dgmpp_attribute_copy_owner			(dgmpp_attribute attribute);
...
#if DEBUG
DGMPP_EXTERN void				dgmpp_attribute_dump_affectors		(dgmpp_attribute attribute);
#endif
#endif /* attribute_h */
