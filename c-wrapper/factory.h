...
DGMPP_EXTERN BOOL				dgmpp_factory_set_schematic_id	(dgmpp_facility facility, dgmpp_schematic_id schematic_id);
...
DGMPP_EXTERN BOOL				dgmpp_factory_get_output		(dgmpp_facility facility, dgmpp_commodity* commodity);
