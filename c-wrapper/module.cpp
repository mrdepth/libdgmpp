...
dgmpp_type dgmpp_module_create (dgmpp_type_id type_id) {
	try {
		return reinterpret_cast<dgmpp_type>(new dgmpp_module_impl(static_cast<TypeID>(type_id)));
	}
	catch (...) {
		return nullptr;
	}
...
dgmpp_array dgmpp_module_get_available_states (dgmpp_type module) {
...
dgmpp_array dgmpp_module_get_charge_groups (dgmpp_type module) {
