...
dgmpp_type dgmpp_ship_create (dgmpp_type_id type_id) {
	try {
		return reinterpret_cast<dgmpp_type>(new dgmpp_ship_impl(static_cast<TypeID>(type_id)));
	}
	catch (...) {
		return nullptr;
	}
...
dgmpp_array dgmpp_ship_get_supported_drone_categories (dgmpp_type ship) {
...
dgmpp_array dgmpp_ship_get_modules (dgmpp_type ship) {
	return dgmpp_make_array<dgmpp_type_impl*>(type_cast<Ship*>(ship)->modules());
}

dgmpp_array dgmpp_ship_get_drones (dgmpp_type ship) {
	return dgmpp_make_array<dgmpp_type_impl*>(type_cast<Ship*>(ship)->drones());
}

dgmpp_array dgmpp_ship_get_modules_slot (dgmpp_type ship, DGMPP_MODULE_SLOT slot) {
...
dgmpp_capacitor_ptr dgmpp_ship_get_capacitor (dgmpp_type ship) {
