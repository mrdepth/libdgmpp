...
DGMPP_EXTERN dgmpp_array_ptr dgmpp_ship_get_modules			(dgmpp_type_ptr ship);
DGMPP_EXTERN dgmpp_array_ptr dgmpp_ship_get_drones			(dgmpp_type_ptr ship);
DGMPP_EXTERN dgmpp_array_ptr dgmpp_ship_get_modules_slot	(dgmpp_type_ptr ship, DGMPP_MODULE_SLOT slot);
