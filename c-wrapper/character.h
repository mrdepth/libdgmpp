...
DGMPP_EXTERN dgmpp_types_array_ptr dgmpp_character_get_skills	(dgmpp_type_ptr character);
...
DGMPP_EXTERN dgmpp_types_array_ptr dgmpp_character_get_implants	(dgmpp_type_ptr character);
DGMPP_EXTERN dgmpp_types_array_ptr dgmpp_character_get_boosters	(dgmpp_type_ptr character);
