...
- (void) testArea {
	...
	gang.area(std::make_shared<Area>(TypeID::class6WolfRayetEffects));
...
- (void) testCapBooster {
	...
	ship->add(std::make_shared<Module>(TypeID::multispectrumShieldHardenerII));
...
- (void) testVindicator1 {
	...
	ship->add(std::make_shared<Module>(TypeID::largeKineticArmorReinforcerI));
	ship->add(std::make_shared<Module>(TypeID::largeThermalArmorReinforcerII));
	...
	ship->add(std::make_shared<Module>(TypeID::largeExplosiveArmorReinforcerII));
...
//	ship->addModule(TypeID::capitalFlexArmorHardenerII)->charge(TypeID::armorExplosiveResistanceScript);
	ship->add(std::make_shared<Module>(TypeID::imperialNavyMultispectrumEnergizedMembrane));
	ship->add(std::make_shared<Module>(TypeID::imperialNavyMultispectrumEnergizedMembrane));
	ship->add(std::make_shared<Module>(TypeID::explosiveArmorHardenerII));
	auto res0 = ship->resistances();
	ship->add(std::make_shared<Module>(TypeID::largeExplosiveArmorReinforcerII));
	auto res1 = ship->resistances();
...
- (void) testNyx {
	...
	ship->add(std::make_shared<Module>(TypeID::explosiveArmorHardenerII));
	auto res0 = ship->resistances();
	ship->add(std::make_shared<Module>(TypeID::capitalExplosiveArmorReinforcerII));
	auto res1 = ship->resistances();
