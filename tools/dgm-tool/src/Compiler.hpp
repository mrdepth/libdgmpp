...
namespace Compiler {
	...
	class Modifier {
	public:
		Modifier(ModifierType type, const Association& association, const AttributeID& attributeID, int32_t modifierID): type(type), modifiedAssociation(association), modifyingAttributeID(attributeID), modifierID(modifierID) {}
