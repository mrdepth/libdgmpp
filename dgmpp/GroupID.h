...
namespace dgmpp {
	enum class GroupID: int {
		...
		structureAXLMissileLauncher = 1327,
		...
		structureASMLMissileLauncher = 1562,
		...
		structureCombatRigMSensorResolution = 1622,
		...
		structureCombatRigLMaxTargetsandSensorResolution = 1635,
		...
		structureResourceRigMHSOreReprocessing = 1647,
		structureResourceRigLOreReprocessing = 1648,
		structureResourceRigXLReprocessing = 1649,
		lightFighter = 1652,
		heavyFighter = 1653,
		citadel = 1657,
		stasisGrappler = 1672,
		...
		structureResourceRigMLNSOreReprocessing = 1693,
		structureResourceRigMIce1Reprocessing = 1694,
		structureResourceRigMIce2Reprocessing = 1695,
		structureResourceRigLIceReprocessing = 1696,
